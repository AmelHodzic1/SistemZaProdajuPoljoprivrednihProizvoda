...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                               	...
                                               	<?php
												$sql="SELECT * FROM seller order by rs_id desc";
																				...
																				$mql="SELECT * FROM res_category where c_id='".$rows['c_id']."'";
																					...
																					echo ' <tr><td>'.$row['c_name'].'</td>
																								...
																								<td>'.$rows['date'].'</td>
																									 ...
																									 <a href="update_seller.php?res_upd='.$rows['rs_id'].'" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="ti-settings"></i></a>
																									</td></tr>';
            ...
            <!-- End Container fluid  -->
            <!-- footer -->
            <footer class="footer"> © 2024 Ris Projekat. </footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
