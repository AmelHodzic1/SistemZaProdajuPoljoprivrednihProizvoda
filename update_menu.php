...
if(isset($_POST['submit']))           //if upload btn is pressed
{
	...
	else
		{
				...
				$fname = $_FILES['file']['name'];
								...
								$store = "Res_img/products/".basename($fnew);                      // the path to store the upload image
					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "update products set rs_id='$_POST[res_name]',title='$_POST[d_name]',slogan='$_POST[about]',price='$_POST[price]',img='$fnew' where d_id='$_GET[menu_upd]'";  // update the submited data ino the database :images
												mysqli_query($db, $sql); 
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Add Product to Seller</h4>
                            </div>
                            <div class="card-body">
